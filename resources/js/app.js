...
document.body.addEventListener("htmx:responseError", function (evt) {
  ...
  div.innerHTML = `
      <div id="alert-1" class="flex items-center p-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800" role="alert">
  ...
  const formWrapper = htmx.find("#form-wrapper");
  if (formWrapper) {
    formWrapper.insertBefore(div, form);
    // // TODO: probably don't need to process the whole thing
